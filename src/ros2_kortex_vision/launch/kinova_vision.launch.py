...
def launch_setup(context, *args, **kwargs):
    ...
    return [
        depth_node,
        color_node,
        # camera_depth_tf_publisher, # Commented out because the depth camera frame is already published by the kinova_vision_node
        # camera_color_tf_publisher, # Commented out because the color camera frame is already published by the kinova_vision_node
        depth_image_proc,
    ]
